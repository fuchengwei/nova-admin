export default {
  ...
  menu: {
    ...
    apiPermissionEditRequired: 'Menu edit permission is required to register or assign roles',
    apiPermissionRoles: 'Assigned Roles',
    apiPermissionAssignRole: 'Select roles',
    apiPermissionRoleSyncFirst: 'Register the permission first',
    apiPermissionRoleUpdateSuccess: 'Role API permissions updated',
    apiPermissionConfigureRoles: 'Configure roles',
    apiPermissionNoAssignedRole: 'No roles assigned',
    apiPermissionRoleModalHint:
      'Choose which roles can access this API permission. Changes apply immediately. API permissions are independent of menu buttons.',
